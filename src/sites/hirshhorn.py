...
class HirshhornParser:
    ...
    def get_api_exhibitions(self, since_year: int | None = None, limit: int | None = None):
        logger.warning("[Hirshhorn] API key required. Register at https://www.si.edu/openaccess")
        return []
