...
class TestGuggenheimParser:
    ...
    def test_get_exhibition_urls_scrapling_mocked(self):
        ...
        p = GuggenheimParser()
        with unittest.mock.patch.object(guggenheim_module, "HAS_SCRAPLING", True), \
             unittest.mock.patch("src.sites.guggenheim.StealthyFetcher", create=True) as mock_fetcher_cls:
